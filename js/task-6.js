...
buttonDestroy.addEventListener('click', () => {
  ...
  const userConfirmed = confirm("Ви дійсно бажаєте все видалити? Сторінка буде очищена, всі дані втрачено!");
  if (userConfirmed) {
    ...
    countdownDiv.textContent = `Дані будуть видалені через ${countdownValue - 1} секунд`;
